...
RUN_CONFIG=${RUN_CONFIG:-"ddfsd_full_steps15000_10pct_schedule"}
...
# Override via environment variables for margin sweeps, e.g.
# M_RF=1.3 M_FF=0.7 bash scripts/train_ddfsd_full_10pct_schedule.sh
M_RF=${M_RF:-1.2}
M_FF=${M_FF:-0.6}
