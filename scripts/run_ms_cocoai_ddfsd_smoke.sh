...
MANIFEST_ROOT=${MANIFEST_ROOT:-"/root/autodl-tmp/MS_COCOAI_extracted/manifests/validation/fewshot"}
...
for required in "${SUPPORT_MANIFEST}" "${QUERY_MANIFEST}" "${CKPT_PATH}" "${FREQ_STATS_PATH}"; do
